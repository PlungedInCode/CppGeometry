...
void testTriangleClass() {
  ...
  std::cout << "Trinagle " << triangle << " " << triangle.verticesCount() << " Convex - "
            << triangle.isConvex() << std::endl;
  ...
  std::cout << "triangle2 " << triangle2 << " " << triangle2.verticesCount() << " Convex - "
            << triangle2.isConvex() << std::endl;
  std::cout << " == " << (triangle2 == triangle) << std::endl;
  std::cout << "IsConguruent " << triangle.isCongruentTo(triangle2) << std::endl;
  ...
  std::cout << "Rotated to " << angle << " from " << center << " triangle " << triangle
            << std::endl;

  triangle.reflex(center);
  std::cout << "Reflex  from " << center << " triangle " << triangle << std::endl;
  ...
  std::cout << "Scaled to " << scale << " from " << center << " triangle " << triangle
            << std::endl;
}
...
int main() {
  ...
  // Point p1(-3, 1), p2(2, 2), p3(-3, -5);
  // Triangle tr(p1, p2, p3);
  // std::cout << tr.orthocenter() << std::endl;
  // testPointClass();
  // std::cout << "=================================================" << std::endl;
  // testLineClass();
  // std::cout << "=================================================" << std::endl;
